...
const TEAM = [
  {
    name: 'Lam Nguyen',
    role: 'Founder & Owner',
    bio: '10+ years of experience in real estate and portrait photo editing.',
  ...
  },
  {
    ...
    bio: 'Creates hyper-realistic virtual staging that helps properties sell faster.',
    img: 'https://i.pravatar.cc/300?img=35',
  },
  {
    name: 'Ha Le',
    role: 'Video Editor',
    bio: 'Specializes in real estate walkthrough and drone video editing with cinematic quality.',
    img: 'https://i.pravatar.cc/300?img=45',
  },
];

const VALUES = [
  { icon: '🎯', title: 'Quality First', desc: 'Every edit undergoes multiple quality checks before delivery.' },
  { icon: '🤝', title: 'Trust & Unity', desc: 'We build lasting partnerships with clients through open communication.' },
  { icon: '🚀', title: 'Innovation', desc: 'Constantly applying the latest editing techniques and technologies.' },
  { icon: '💡', title: 'Artistic Vision', desc: 'Bringing a creative, fresh perspective to every project we take on.' },
];
    ...
    <>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold">About Skyline Visual Studio</h1>
          <p className="text-gray-300 text-lg mt-5 max-w-2xl mx-auto leading-relaxed">
            A passionate team of photo editing experts, dedicated to helping you showcase your work at its very best.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 mt-4 leading-relaxed">
              ...
              services tailored to your needs. With over 10 years of experience, we have grown into a
              globally trusted team operating across more than 10 countries worldwide.
            </p>
            <p className="text-gray-500 mt-4 leading-relaxed">
              We believe every photographer, real estate agent, and business deserves access to
              world-class photo editing — regardless of budget or location.
              Our skilled editors deliver in 12–24 hours without ever compromising on quality.
            </p>
            <div className="grid grid-cols-3 gap-4 mt-8">
              {[
                { num: '10+', label: 'Years Experience' },
                { num: '10+', label: 'Countries Served' },
                { num: '12–24h', label: 'Fast Delivery' },
              ].map(s => (
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <h2 className="section-title mt-2">Our Talented Editors</h2>
            <p className="section-subtitle">
              A dedicated team of professionals passionate about making your photos look their absolute best.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1">
            ...
            <p className="text-gray-500 mt-4 leading-relaxed">
              We foster a work culture built on trust, creativity, and unity. Team-building activities
              strengthen relationships and ensure every member gives their best to each project.
            </p>
            <p className="text-gray-500 mt-4 leading-relaxed">
              From regular knowledge-sharing sessions to team outings, we invest in our people because
              we believe a happy, connected team produces the best results for our clients.
            </p>
